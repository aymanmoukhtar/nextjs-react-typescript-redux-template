...
/* harmony import */ var _src_reducers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/reducers */ "./src/reducers/index.ts");
...
var initialState = {
  home: _src_reducers__WEBPACK_IMPORTED_MODULE_2__["homeInitialState"]
};
var rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_3__["combineReducers"])({
  home: _src_reducers__WEBPACK_IMPORTED_MODULE_2__["homeReducer"]
});

var initStore = function initStore() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialState;
  return Object(redux__WEBPACK_IMPORTED_MODULE_3__["createStore"])(rootReducer, state, Object(redux_devtools_extension__WEBPACK_IMPORTED_MODULE_4__["composeWithDevTools"])());
};
...
var Page = function Page(props) {
  ...
  return __jsx(react_redux__WEBPACK_IMPORTED_MODULE_6__["Provider"], {
    ...
    __self: this
  }, "NextJS Template")), __jsx(Component, Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({}, pageProps, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42
    },
...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_redux_wrapper__WEBPACK_IMPORTED_MODULE_7__["default"])(initStore)(Page));


/***/ }),

/***/ "./src/actions/action-ids.ts":
/*!***********************************!*\
  !*** ./src/actions/action-ids.ts ***!
  \***********************************/
/*! exports provided: default */
...
var actionIds = {
  ...
  APP_GET_DATA: '[APP] GET DATA'
};
/* harmony default export */ __webpack_exports__["default"] = (actionIds);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeTitleAction", function() { return changeTitleAction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDataAction", function() { return getDataAction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDataAsync", function() { return getDataAsync; });
...
/* harmony import */ var _action_ids__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./action-ids */ "./src/actions/action-ids.ts");




var actionCreator = typescript_fsa__WEBPACK_IMPORTED_MODULE_0___default()();
var changeTitleAction = actionCreator(_action_ids__WEBPACK_IMPORTED_MODULE_3__["default"].APP_CHANGE_TITLE);
var getDataAction = actionCreator.async(_action_ids__WEBPACK_IMPORTED_MODULE_3__["default"].APP_GET_DATA);
var getDataAsync = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["async"])(getDataAction, _api_home__WEBPACK_IMPORTED_MODULE_1__["homeApi"].getData);
...
var homeApi = {
  getData: function getData() {
    return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.resolve(['Data 1', 'Data 2']);
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shared_async_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/async-action */ "./src/helpers/shared/async-action.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "async", function() { return _shared_async_action__WEBPACK_IMPORTED_MODULE_0__["async"]; });



/***/ }),

/***/ "./src/helpers/shared/async-action.ts":
/*!********************************************!*\
  !*** ./src/helpers/shared/async-action.ts ***!
  \********************************************/
/*! exports provided: async */
...
var async = function async(action, worker) {
  return function (dispatch, params) {
    dispatch(action.started(params));
    return worker(params).then(function (result) {
...
/*!******************************!*\
  !*** ./src/reducers/home.ts ***!
  \******************************/
/*! exports provided: homeReducer, homeInitialState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "homeReducer", function() { return homeReducer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "homeInitialState", function() { return initialState; });
...
/* harmony import */ var typescript_fsa__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! typescript-fsa */ "./node_modules/typescript-fsa/lib/index.js");
...
var homeReducer = function homeReducer() {
  ...
  if (Object(typescript_fsa__WEBPACK_IMPORTED_MODULE_7__["isType"])(action, _actions__WEBPACK_IMPORTED_MODULE_8__["changeTitleAction"])) {
    return _objectSpread({}, state, {
      title: action.payload
    });
  }

  if (Object(typescript_fsa__WEBPACK_IMPORTED_MODULE_7__["isType"])(action, _actions__WEBPACK_IMPORTED_MODULE_8__["getDataAction"].started)) {
    // Do data loading ui work if needed.
    return _objectSpread({}, state);
  }

  if (Object(typescript_fsa__WEBPACK_IMPORTED_MODULE_7__["isType"])(action, _actions__WEBPACK_IMPORTED_MODULE_8__["getDataAction"].done)) {
    return _objectSpread({}, state, {
      data: action.payload.result
    });
  }

  if (Object(typescript_fsa__WEBPACK_IMPORTED_MODULE_7__["isType"])(action, _actions__WEBPACK_IMPORTED_MODULE_8__["getDataAction"].failed)) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home */ "./src/reducers/home.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "homeReducer", function() { return _home__WEBPACK_IMPORTED_MODULE_0__["homeReducer"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "homeInitialState", function() { return _home__WEBPACK_IMPORTED_MODULE_0__["homeInitialState"]; });
